...
public class CartAdapter extends ArrayAdapter<CartItem> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.hoatdonggiaitri_cart_item, parent, false);
        }
    ...
    private void showEditQuantityDialog(final int position, final CartItem cartItem) {
        ...
        View dialogView = LayoutInflater.from(context).inflate(R.layout.hoatdonggiaitri_dialog_edit_quantity, null);
    ...
    private void showCheckoutConfirmationDialog(final int position, final CartItem cartItem) {
        ...
        View dialogView = LayoutInflater.from(context).inflate(R.layout.hoatdonggiaitri_checkout_confirmation_dialog, null);
    ...
    private void performCheckout(int position, CartItem cartItem) {
        ...
        db.delete("giohang_diadiem", "id=?", new String[]{String.valueOf(cartItem.getId())});
        remove(getItem(position));
        notifyDataSetChanged();
        db.close();
    }
