...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hoatdonggiaitri_activity_cart);
    ...
    private void showEditQuantityDialog(final CartItem itemToEdit) {
        ...
        View dialogView = LayoutInflater.from(this).inflate(R.layout.hoatdonggiaitri_dialog_edit_quantity, null);
